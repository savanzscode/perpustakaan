...
if (isset($_POST['Simpan'])){
    ...
    // Membuat tgl kembali (7 hari dari tgl pinjam)
    $tgl_k = date('Y-m-d', strtotime('+7 days', strtotime($tgl_p)));
    $tgl_hk = date('Y-m-d');
    
    // Query untuk memasukkan data ke tb_sirkulasi
    $sql_simpan = "
    INSERT INTO tb_sirkulasi (id_sk, id_buku, id_anggota, tgl_pinjam, status, tgl_kembali) VALUES (
        '".$_POST['id_sk']."',
        '".$_POST['id_buku']."',
        '".$_POST['id_anggota']."',
        '".$_POST['tgl_pinjam']."',
    ...
    INSERT INTO log_pinjam (id_buku, id_anggota, tgl_pinjam) VALUES (
        '".$_POST['id_buku']."',
        '".$_POST['id_anggota']."',
        '".$_POST['tgl_pinjam']."'
    );
